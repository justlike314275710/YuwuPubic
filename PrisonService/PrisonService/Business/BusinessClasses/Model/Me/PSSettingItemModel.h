...
typedef NS_ENUM(NSInteger, PSSettingAccessoryType) {
    PSSettingAccessoryTypeNone,                   // don't show any accessory view
    PSSettingAccessoryTypeDisclosureIndicator,    // the same with system DisclosureIndicator
    PSSettingAccessoryTypeSwitch,                 //  swithch
};



@interface PSSettingItemModel : NSObject
...
@property (nonatomic,assign) PSSettingAccessoryType  accessoryType;    /**< accessory */
